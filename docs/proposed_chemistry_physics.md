...
> **Note**: The root-level `proposed_chemistry_physics.md` is now the single source of truth for this document. This file (`docs/proposed_chemistry_physics.md`) has been consolidated to avoid duplication. For full details on each breakthrough, refer to the root-level file.
